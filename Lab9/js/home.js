        ...
        success: function (jsonResponse){    
            ...
            $('#commentSection').on('scroll', function() {
                if($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight) {
                    $("#overflowAlert").fadeOut("slow", function() {
                        $(this).remove();
                    });
                }
            });
...
function getFriendsData(urlPHP) {
    ...
    $.ajax({
        ...
        success: function (jsonResponse){    
            ...
            $('#listFriendsSection').on('scroll', function() {
                if($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight) {
                    $("#overflowFriendsAlert").fadeOut("slow", function() {
                        $(this).remove();
                    });
                }
            });
...
function getRequestsData(urlPHP) {
    ...
    $.ajax({
        ...
        success: function (jsonResponse){    
            ...
            $('#listRequestsSection').on('scroll', function() {
                if($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight) {
                    $("#overflowAlertRequests").fadeOut("slow", function() {
                        $(this).remove();
                    });
                }
            });
...
function startSearch(urlPHP){
    ...
    $.ajax({
        ...
        success: function (jsonResponse){    
            ...
            $('#listSearchSection').on('scroll', function() {
                if($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight) {
                    $("#overflowAlert").fadeOut("slow", function() {
                        $(this).remove();
                    });
